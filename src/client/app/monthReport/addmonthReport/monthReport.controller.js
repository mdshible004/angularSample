(function () {
    ...
    angular
        ...
        .controller('monthReportController', monthReportController);

        monthReportController.$inject = ['monthlyFeeReportService','studentAtdReportSettingsService','filterurl', '$q', 'authservice', 'logger', '$scope', '$rootScope', '$state', 'Upload', '$timeout', '$http', '$interval', 'uiGridConstants', '$localStorage'];
    /* @ngInject */
    function monthReportController(monthlyFeeReportService,studentAtdReportSettingsService , filterurl, $q, authservice, logger, $scope, $rootScope, $state, Upload, $timeout, $http, $interval, uiGridConstants, $localStorage) {
