(function () {
    ...
    angular
        ...
        .controller('openingTrialBalanceReportController', openingTrialBalanceReportController);

    openingTrialBalanceReportController.$inject = ['openingTrailBalanceReport','trailBalanceReport','conversion','teacherAttendanceSevice','commonService','filterurl', '$q', 'authservice', 'logger', '$scope', '$rootScope', '$state', 'Upload', '$timeout', '$http', '$interval', 'uiGridConstants', '$localStorage', 'apiConfig'];
    /* @ngInject */
    function openingTrialBalanceReportController(openingTrailBalanceReport,trailBalanceReport,conversion,teacherAttendanceSevice,commonService,filterurl, $q, authservice, logger, $scope, $rootScope, $state, Upload, $timeout, $http, $interval, uiGridConstants, $localStorage,apiConfig) {
       ...
       // $scope.totalReturn += $scope.getDailyFees[i].ReturnAmount;
        ...
        vm.getTrailBalaceReport = function () {
           ...
           // === created for test.... 
            ...
            //    }
            return openingTrailBalanceReport.getOpeningTrailBalance(params)
                    .then(function (data) {
