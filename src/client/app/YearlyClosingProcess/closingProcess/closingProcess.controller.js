...
(function () {
    ...
    angular
        ...
        .controller('closingProcessController', closingProcessController);


        closingProcessController.$inject = [ 'filterurl', '$q', 'authservice', 'logger', '$scope', '$localStorage', '$rootScope', '$state', 'Upload', '$timeout', '$http', '$interval', 'uiGridConstants'];
    function closingProcessController(filterurl, $q, authservice, logger, $scope, $localStorage, $rootScope, $state, Upload, $timeout, $http, $interval, uiGridConstants) {
