...
(function () {
    ...
    angular
        ...
        .controller('BankReceiveController', BankReceiveController);


    BankReceiveController.$inject = ['filterurl', '$q', 'authservice', 'logger', '$scope', '$localStorage', '$rootScope', '$state', 'Upload', '$timeout', '$http', '$interval', 'uiGridConstants'];
    function BankReceiveController(filterurl, $q, authservice, logger, $scope, $localStorage, $rootScope, $state, Upload, $timeout, $http, $interval, uiGridConstants) {
