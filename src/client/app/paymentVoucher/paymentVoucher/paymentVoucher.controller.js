(function () {
    ...
    angular
        ...
        .controller('PaymentVoucherController', PaymentVoucherController);


    PaymentVoucherController.$inject = ['journalService', 'filterurl', '$q', 'authservice', 'commonService', 'conversion', 'chartOfAccountsService', 'logger', '$scope', '$localStorage', '$rootScope', '$state', 'Upload', '$timeout', '$http', '$interval', 'uiGridConstants'];

    function PaymentVoucherController(journalService, filterurl, $q, authservice, commonService, conversion, chartOfAccountsService, logger, $scope, $localStorage, $rootScope, $state, Upload, $timeout, $http, $interval, uiGridConstants) {
            ...
            return journalService.InsertJournalData(FuncName, objcmnParam)
                .then(function (data) {
                    if (data[0] !== null) {
                        ...
                        vm.PayNO = data[0].ManualVoucherNo;
                        vm.brunch = {
                    ...
                    if (data.length > 0) {
                        angular.forEach(data, function (detail) {
                            ...
                            if (detail.DrAmount !== 0) {
                                ...
                                vm.PayToID = vm.Type.selected.UserID;
