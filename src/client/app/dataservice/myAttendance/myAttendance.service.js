(function () {
    ...
    myAttendanceService.$inject = ['$http', '$q', 'logger', 'apiConfig'];
    /* @ngInject */
    function myAttendanceService($http, $q, logger, apiConfig) {
        var service = {
           getMonths : getMonths,
           getHrmSubWiseAtdDetail : getHrmSubWiseAtdDetail,
           getMonthlyAttendence:getMonthlyAttendence,
           getAllSubjectAtd : getAllSubjectAtd,
           getAllTeacherInfoForReport:getAllTeacherInfoForReport
 ...
 function getAllTeacherInfoForReport(params) {
            
            return $http.get(apiConfig.host + '/getAttendenceReportForTeacher/' + params.Branch + '/' + params.Department + '/' + params.MonthID + '/' + params.InstituteID + '/' + params.RFID, params)
            .then(success)
            .catch(fail);
