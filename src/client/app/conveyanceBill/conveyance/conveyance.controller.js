...
(function () {
    ...
    angular
        ...
        .controller('conveyanceController', conveyanceController);


    conveyanceController.$inject = ['filterurl', '$q', 'authservice', 'logger', '$scope', '$localStorage', '$rootScope', '$state', 'Upload', '$timeout', '$http', '$interval', 'uiGridConstants'];
    function conveyanceController(filterurl, $q, authservice, logger, $scope, $localStorage, $rootScope, $state, Upload, $timeout, $http, $interval, uiGridConstants) {
