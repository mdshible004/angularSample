...
//Token Generate Decleration
        ...
        vm.getHomeWork= function () {
           // var a;
            ...
            return homeWorkEntry.getMyInsHomeWork(params)
                .then(function (data) {
        ...
        $scope.loadTopicPopUp = function (dataModel, index) {
            ...
            vm.TopicDetails = dataModel.TopicDetails;
            authservice.getToken(generateSecurityToken(vm.InstituteID, vm.LoggedUserID, vm.menuId, vm.getMethod)) //jshint ignore : line

            $scope.showItem = true;
            var Params = {
                HomeWorkID: dataModel.HomeWorkID

            };
            return homeWorkEntry.getMyInsHomeWorkDetail(Params)
                .then(function (data) {
